          ...
          <nav className="hidden md:flex items-center space-x-8">
            {user ? (
              ...
              <>
                ...
                <Link to="/register" className="bg-accent-500 hover:bg-accent-600 px-4 py-2 rounded-lg text-white font-medium transition-colors">
                  Register
                </Link>
              </>
            )}
          ...
          <nav className="md:hidden py-4 border-t border-primary-700">
            {user ? (
              <div className="space-y-2">
                <Link to="/game" className="block hover:bg-primary-700 px-4 py-2 rounded-lg transition-colors">
                  Play Game
                </Link>
                <Link to="/stats" className="block hover:bg-primary-700 px-4 py-2 rounded-lg transition-colors">
                  My Stats
                </Link>
              ...
              <div className="space-y-2">
                <Link to="/login" className="block hover:bg-primary-700 px-4 py-2 rounded-lg transition-colors">
                  Login
                </Link>
                <Link to="/register" className="block bg-accent-500 hover:bg-accent-600 px-4 py-2 rounded-lg text-white font-medium transition-colors">
                  Register
                </Link>
              </div>
            )}
