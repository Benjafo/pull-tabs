    ...
    return (
        <div className="relative">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute top-40 right-20 text-8xl opacity-5 animate-bounce" style={{animationDelay: '0.5s', animationDuration: '3s'}}>🏴‍☠️</div>
                <div className="absolute bottom-20 left-1/4 text-7xl opacity-5 animate-pulse" style={{animationDelay: '1s'}}>💎</div>
                <div className="absolute bottom-40 right-1/3 text-5xl opacity-5 animate-bounce" style={{animationDelay: '1.5s', animationDuration: '3s'}}>🪙</div>
            </div>
